...
const ROLE_PERMISSIONS = {
  ...
  senior_pastor: [
    P.MANAGE_USERS, P.VIEW_MEMBERS, P.EDIT_MEMBERS, P.MANAGE_MINISTRIES, P.MANAGE_CELL_GROUPS,
    ...
    P.VIEW_PROJECTS, P.MANAGE_PROJECTS, P.MANAGE_MINISTRY_TASKS, P.MANAGE_WORKFLOW_TEMPLATES,
  ],
